import {
  ...
  import { showAddEdit } from "./studentCRUD.js";
  ...
  export const handleJobs = () => {
    ...
    jobsDiv.addEventListener("click", (e) => {
      if (inputEnabled && e.target.nodeName === "BUTTON") {
        ...
        message.textContent = "";
        showAddEdit(e.target.dataset.id ,"update");
      }
      else if (e.target.classList.contains("deleteButton")) {
        message.textContent = "Do you wan to delete this record?";
        showAddEdit(e.target.dataset.id , "delete");
      }}
    });
  };
